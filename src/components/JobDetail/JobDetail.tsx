              ...
              <div className="jobDetail__details__company-main__details">
                ...
                <div className="jobDetail__details__company-main__details__description">
                  <p>
                    ...
                    and strategic mindset to drive sales and build lasting
                    client.
                  </p>
                </div>
            ...
            <div className="jobDetail__blabla__container">
              <div className="jobDetail__blabla__container__about">
                ...
                <p>
                  ...
                  delivering innovative solutions and driving exceptional growth
                  in the market. As we expand our team, we are seeking a highly
                  motivated and results-oriented Marketing Sales Representative
                  to join us in achieving our ambitious sales targets and
              ...
              <div className="jobDetail__blabla__container__role">
                ...
                <p>
                  ...
                  client relationships. You will be responsible for effectively
                  promoting our products/services, identifying new business
                  opportunities, and converting leads into sales. Your keen
                  understanding of market trends and customer needs will enable
                  you to develop and implement strategic sales plans to maximize
                  our market share and exceed targets.
                </p>
              </div>
              ...
              <div className="jobDetail__blabla__container__additional">
                ...
                <p>
                  ...
                  benefits package. If you are a results-driven individual with
                  a passion for sales and a desire to grow your career in a
                  dynamic environment, we want to hear from you!
                </p>
              </div>
